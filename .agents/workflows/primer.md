---
description: Core project context — architecture, API surface, tech stack
---
...
- **Graph Explorer**: Neo4j Aura–style with 4 selectable layouts (Force, Radial, Hierarchy, Grid).
